...
class SandwichPluginManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    ...
    $plugin_definition_annotation_name = 'Drupal\plugin_type_example\Annotation\Sandwich';
    ...
    // see cms_custom_plugin_manager_sandwich_info_alter().
    ...
    // service be used in the cms_custom_plugin_manager_example.services.yml file. The second
